...
export default function CGU() {
  return (
    <section className="bg-[#E4E2DD] mb-12">
      <h1 className="text-3xl md:text-5xl font-bold text-center mb-12">Conditions Générales d'Utilisation</h1>
      <div className="max-w-3xl mx-auto p-6 text-sm leading-relaxed bg-[#F8F5F1]">
        {/* <h1 className="text-2xl font-bold mb-6">Conditions Générales d'Utilisation</h1> */}

        <p>
          Le site MAÏLYS.fr est édité par [Heidi Gouider], micro-entrepreneuse déclarée sous le numéro SIRET [XXXXXXXXXXXXX], dont le siège est situé à Amiens.
        </p>
