...
export default function Services() {
  ...
  return (
    <section id="services" className="py-20 bg-[#F8F5F1] text-gray-text">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center mb-12">Services Proposés</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            <div
              ...
              className="relative group rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300 bg-beige-dark"
            >
              {/* Image */}
              <img
                src={service.image}
              ...
              <div className="absolute bottom-0 left-0 w-full bg-[#E4E2DD] bg-opacity-90 text-[#A68FA3] px-4 py-2">
              ...
              <div className="absolute inset-0 bg-[#E4E2DD] bg-opacity-90 flex flex-col justify-center items-center text-center px-4 opacity-0 group-hover:opacity-100 transition duration-300 text-white">
                <h3 className="text-xl text-[#A68FA3] font-bold mb-2">{service.title}</h3>
                <p className="text-sm text-[#A68FA3]">{service.description}</p>
              </div>
            </div>
          ))}
        </div>
